...
import mod.arcomit.emberthral.render.particles.DMC.JustJudgementCutMarksParticles;
...
public class ParticleRegistry {
    private static final DeferredRegister<ParticleType<?>> PARTICLE_TYPES =
            DeferredRegister.create(ForgeRegistries.PARTICLE_TYPES, Emberthral.MODID);
