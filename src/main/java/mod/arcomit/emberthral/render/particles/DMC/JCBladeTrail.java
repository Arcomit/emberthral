package mod.arcomit.emberthral.render.particles.DMC;
...
import static mod.arcomit.emberthral.render.particles.EMBERTHRALRenderType.getBloomRenderTypeByTexture;
